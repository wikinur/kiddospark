		...
		<div class="row">
			<div class="col-sm-9 padding-right">
				...
				<div class="features_items"><!--features_items-->
					...
					<?php
						if ($jenis_video->num_rows()>0) {
        					foreach ($jenis_video->result_array() as $value) {?>
					<div class="col-sm-4">
						<div class="product-image-wrapper">
							<div class="single-products">
								<div class="productinfo text-center" style="height: 420px; width: 250px;">
									...
									<br>
									<p class="pull-center" style="margin-right: 40px;"><i class="fa fa-eye"></i> <?php echo $value['dilihat'];?> Kali   </p>
